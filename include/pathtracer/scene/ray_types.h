...
// Brute-force reference intersection, an O(n) triangle scan: the correctness oracle for tools/embree_validate.cpp,
// deliberately dependency-free and simple enough to be obviously right.
