...
// One aggregate counter, not a per-object registry: the HUD needs the running total, never a breakdown.
...
// Free plus inactive page bytes (host_statistics64): an approximation, inactive pages being reclaimable rather than in use.
