...
// IEEE 754 binary16, the compiler's native half, bit-identical to OpenEXR HALF: AArch64 widens it with one FCVT, not Imath's 256 KB table.
using Half = _Float16;
static_assert(sizeof(Half) == 2, "binary16 must be 2 bytes to alias OpenEXR HALF data");

// binary16 parameters (IEEE 754-2008 Table 3.2): p = 11, emax = 15. Derived here; libc++ does not specialise numeric_limits<_Float16>.
...
// Storage precision of image data: Float16 (11-bit significand, unit roundoff 2^-11, finite max 65504) or Float32, an exact copy.
