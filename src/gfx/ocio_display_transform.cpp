...
//
// OCIO::Exception here means our own config/display/view/style names are wrong — an internal defect, not recoverable input — so it exits immediately like Window/HdrFramebuffer do for unrecoverable configuration errors, rather than threading optional through callers.
