...
// 0=Beauty 1=Alpha 2=Depth 3=HSV 4=Luminance 5=Sobel 6=Gabor 7=WorldPos 8=UV 9=Normal 10=GeomNormal 11=Albedo 12=Metallic 13=Roughness 14=Tangent 15=ObjectID 16=AO 17=Fresnel 18=IBL -- must match hud_overlay.cpp's kAovNames. Sobel/Gabor (5/6) only need this shader to output Luminance (same as 4) -- the actual edge filtering is a second pass, see edge_filter.frag.
uniform int uAov;
